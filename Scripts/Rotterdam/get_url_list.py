...
root_url_huur = 'http://www.funda.nl/huur/rotterdam/'
root_url_verhuurd = 'http://www.funda.nl/huur/verhuurd/rotterdam/'
root_url_koop = 'http://www.funda.nl/koop/rotterdam/'
root_url_verkocht = 'http://www.funda.nl/koop/verkocht/rotterdam/'
...
def within_website(url):
	...
	a = (url.find('www.funda.nl/koop/rotterdam/') != -1)
	return a

def is_apart(url):
	"""Check whether a url is an apartment page"""
	a = (url.find('www.funda.nl/huur/rotterdam/appartement-') != -1)
	b = (url.find('www.funda.nl/huur/verhuurd/rotterdam/appartement-') != -1)
	d = (url.find('www.funda.nl/koop/rotterdam/appartement-') != -1)
	e = (url.find('www.funda.nl/koop/verkocht/rotterdam/appartement-') != -1)
